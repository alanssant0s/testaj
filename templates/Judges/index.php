...
<div class="page-title-box d-sm-flex align-items-center justify-content-between">
    <h4 class="mb-sm-0">Listagem de Juizes</h4>
...
<div class="col-lg-12">
    <div class="card">
        <div class="card-body">
            <div id="categories">
                <a href="<?= $this->Url->build("/judges/add") ?>" class="btn btn-success"><i class="ri-add-line align-bottom me-1"></i> Adicionar</a>
                                ...
                                <tr>
                                    ...
                                    <td class="actions noExport">
                                        <div class="d-flex gap-2">
                                            <?= $this->Html->link(__('Editar'), ['action' => 'edit', $judge->id], ['class' => 'btn btn-sm btn-primary btn-flat']) ?>
                                            <?= $this->Form->postLink(__('Remover'), ['action' => 'delete', $judge->id], ['class' => 'btn btn-sm btn-danger btn-flat', 'confirm' => __('Tem certeza que deseja remover o Juíz "{0}"?', $judge->name)]) ?>
                                        </div>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
