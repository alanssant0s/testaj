...
(function () {
	...
	function setLanguage(lang) {
		if (document.getElementById("header-lang-img")) {
			if (lang == "en") {
				document.getElementById("header-lang-img").src = baseURL + "assets/images/flags/us.svg";
			} else if (lang == "sp") {
				document.getElementById("header-lang-img").src = baseURL +"assets/images/flags/spain.svg";
			} else if (lang == "gr") {
				document.getElementById("header-lang-img").src = baseURL +"assets/images/flags/germany.svg";
			} else if (lang == "it") {
				document.getElementById("header-lang-img").src = baseURL +"assets/images/flags/italy.svg";
			} else if (lang == "ru") {
				document.getElementById("header-lang-img").src = baseURL +"assets/images/flags/russia.svg";
			} else if (lang == "ch") {
				document.getElementById("header-lang-img").src = baseURL +"assets/images/flags/china.svg";
			} else if (lang == "fr") {
				document.getElementById("header-lang-img").src = baseURL +"assets/images/flags/french.svg";
			}
	...
	function toggleHamburgerMenu() {
		...
		if (document.documentElement.getAttribute("data-layout") === "horizontal") {
			if(document.body.classList.contains("menu")){
                ...
                setCookie("hamburguer_enable", 0, 30);  // Save the side bar enable in a cookie for 30 days
            } else{
                document.body.classList.add("menu");
                setCookie("hamburguer_enable", 1, 30);  // Save the side bar enable in a cookie for 30 days
            }
		}
	...
	function getElementUsingTagname(ele, val) {
		...
		document.querySelectorAll("[name='data-sidebar']").forEach(function (elem) {
			...
			} else if(document.querySelector("#collapseBgGradient .form-check input:checked") != null){
    ...
    function setLayoutMode(mode, modeType, modeTypeId, html) {
        ...
        setCookie("layout_mode", modeType, 30);  // Save the layout mode in a cookie for 30 days
